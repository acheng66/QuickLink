...
public class RecycleBinController {
    ...
    public Result<IPage<QuickLinkPageRespDTO>> pageQuickLink(QuickLinkRecycleBinPageReqDTO requestParam) {
        return Results.success(recycleBinService.pageQuickLink(requestParam));
    }
