...
public interface LinkNetworkStatsMapper extends BaseMapper<LinkNetworkStatsDO> {
    ...
    void quickLinkNetworkState(@Param("linkNetworkStats") LinkNetworkStatsDO linkNetworkStatsDO);
    ...
    List<LinkNetworkStatsDO> listNetworkStatsByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    tl.gid, tlns.network;")
    List<LinkNetworkStatsDO> listNetworkStatsByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
}
