...
public interface LinkDeviceStatsMapper extends BaseMapper<LinkDeviceStatsDO> {
    ...
    void quickLinkDeviceState(@Param("linkDeviceStats") LinkDeviceStatsDO linkDeviceStatsDO);
    ...
    List<LinkDeviceStatsDO> listDeviceStatsByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    tl.gid, tlds.device;")
    List<LinkDeviceStatsDO> listDeviceStatsByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
}
