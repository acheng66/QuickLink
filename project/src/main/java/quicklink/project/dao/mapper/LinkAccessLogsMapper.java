...
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {
    ...
    @Select("SELECT " +
            ...
            "    count DESC " +
            "LIMIT 5;")
    List<HashMap<String, Object>> listTopIpByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "    count DESC " +
            "LIMIT 5;")
    List<HashMap<String, Object>> listTopIpByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "        tlal.user " +
            ") AS user_counts;")
    HashMap<String, Object> findUvTypeCntByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    LinkAccessStatsDO findPvUvUidStatsByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    tl.gid;")
    LinkAccessStatsDO findPvUvUidStatsByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
    ...
    IPage<LinkAccessLogsDO> selectGroupPage(@Param("param") QuickLinkGroupStatsAccessRecordReqDTO requestParam);
}
