...
public interface LinkOsStatsMapper extends BaseMapper<LinkOsStatsDO> {
    ...
    void quickLinkOsState(@Param("linkOsStats") LinkOsStatsDO linkOsStatsDO);
    ...
    List<HashMap<String, Object>> listOsStatsByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    tl.gid, tlos.os;")
    List<HashMap<String, Object>> listOsStatsByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
}
