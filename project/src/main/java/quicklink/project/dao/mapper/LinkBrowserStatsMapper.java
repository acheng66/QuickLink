...
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStatsDO> {
    ...
    void quickLinkBrowserState(@Param("linkBrowserStats") LinkBrowserStatsDO linkBrowserStatsDO);
    ...
    List<HashMap<String, Object>> listBrowserStatsByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    tl.gid, tlbs.browser;")
    List<HashMap<String, Object>> listBrowserStatsByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
}
