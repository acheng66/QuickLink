...
public interface LinkAccessStatsMapper extends BaseMapper<LinkAccessStatsDO> {
    ...
    void quickLinkStats(@Param("linkAccessStats") LinkAccessStatsDO linkAccessStatsDO);
    ...
    List<LinkAccessStatsDO> listStatsByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    tl.gid, tlas.date;")
    List<LinkAccessStatsDO> listStatsByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
    ...
    List<LinkAccessStatsDO> listHourStatsByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    tl.gid, tlas.hour;")
    List<LinkAccessStatsDO> listHourStatsByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
    ...
    List<LinkAccessStatsDO> listWeekdayStatsByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "    tl.gid, tlas.weekday;")
    List<LinkAccessStatsDO> listWeekdayStatsByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
}
