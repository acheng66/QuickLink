...
public interface LinkLocaleStatsMapper extends BaseMapper<LinkLocaleStatsDO> {
    ...
    void quickLinkLocaleState(@Param("linkLocaleStats") LinkLocaleStatsDO linkLocaleStatsDO);
    ...
    List<LinkLocaleStatsDO> listLocaleByQuickLink(@Param("param") QuickLinkStatsReqDTO requestParam);
    ...
    List<LinkLocaleStatsDO> listLocaleByGroup(@Param("param") QuickLinkGroupStatsReqDTO requestParam);
}
